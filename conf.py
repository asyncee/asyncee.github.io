...
BLOG_AUTHOR = "Stanislav Lobanov"  # (translatable)
BLOG_TITLE = "Asyncee"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://asyncee.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://asyncee.github.io/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Stanislav Lobanov"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (("/archive.html", "Архив"), ("/categories/", "Тэги"), ("/rss.xml", "RSS лента"))
}
...
DATE_FORMAT = "Опубликовано dd MMMM YYYY"
...
REDIRECTIONS = [
    (
        "2016/04/07/nastrojka-webpack-dlya-raboty-s-react-i-scss/index.html",
        "/posts/nastrojka-webpack-dlya-raboty-s-react-i-scss/",
    ),
    ("2016/03/29/ustanovka-kitematic-v-linux/index.html", "/posts/ustanovka-kitematic-v-linux/"),
    (
        "2016/03/23/cepochka-vyzova-metodov-v-python/index.html",
        "/posts/cepochka-vyzova-metodov-v-python/",
    ),
    (
        "2016/03/13/poluchenie-pervogo-elementa-spiska/index.html",
        "/posts/poluchenie-pervogo-elementa-spiska/",
    ),
    (
        "2016/03/11/vspomogatelnye-obuekty-dlya-verstalshika-v-django/index.html",
        "/posts/vspomogatelnye-obuekty-dlya-verstalshika-v-django/",
    ),
    (
        "2016/03/10/ustanovka-tipografskoj-raskladki-ili-birmana-v-linux-mint-173/index.html",
        "/posts/ustanovka-tipografskoj-raskladki-ili-birmana-v-linux-mint-173/",
    ),
    ("2016/03/02/django-19-i-robokassa/index.html", "/posts/django-19-i-robokassa/"),
    (
        "2017/03/14/advanced-django-querying-sorting-events-by-date/index.html",
        "/posts/advanced-django-querying-sorting-events-by-date/",
    ),
    (
        "2017/03/12/how-to-push-to-multiple-git-remotes/index.html",
        "/posts/how-to-push-to-multiple-git-remotes/",
    ),
    (
        "2017/03/10/how-to-configure-flake-8-with-pycharm-2016-3/index.html",
        "/posts/how-to-configure-flake-8-with-pycharm-2016-3/",
    ),
    ("2017/03/02/gorgeous-python-3/index.html", "/posts/gorgeous-python-3/"),
    ("2017/02/24/moving-to-jekyll/index.html", "/posts/moving-to-jekyll/"),
    ("2016/05/15/django-webpack-bower-i-gulp/index.html", "/posts/django-webpack-bower-i-gulp/"),
    (
        "2016/04/25/kak-zagruzit-i-sohranit-fajl-iz-interneta-v-pole-modeli-django/index.html",
        "/posts/kak-zagruzit-i-sohranit-fajl-iz-interneta-v-pole-modeli-django/",
    ),
    (
        "2016/04/17/ustanovka-postgresql-v-ubuntu-linut-mint/index.html",
        "/posts/ustanovka-postgresql-v-ubuntu-linut-mint/",
    ),
    (
        "2016/04/12/shablon-dlya-prototipirovaniya-komponentov-na-reactjs-v-brauzere/index.html",
        "/posts/shablon-dlya-prototipirovaniya-komponentov-na-reactjs-v-brauzere/",
    ),
]
...
# is in the manual.
COMMENT_SYSTEM_ID = "asyncee-github-io"
